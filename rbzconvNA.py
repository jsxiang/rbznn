...
model.fit(X_train, y_train,nb_epoch=512, batch_size=1024, verbose=1, show_accuracy=True, validation_data=(X_valid, y_valid),callbacks=[earlystopper])
out=model.predict(X_test, batch=512, verbose=1)
# model.fit(X_train, y_train, batch_size=256, nb_epoch=60,  verbose=1, show_accuracy=True, shuffle=True, validation_data=(X_valid, y_valid))#, callbacks=[checkpointer,earlystopper])
